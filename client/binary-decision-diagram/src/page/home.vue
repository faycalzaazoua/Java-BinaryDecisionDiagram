<template>
  ...
  <div class="w-full flex justify-center">
    <div class="grid grid-cols-1 space-y-28 w-full mx-40">
      ...
      <div>
        <span class="text-4xl">Que souhaitez-vous faire ?</span>
      </div>
      <div class="grid grid-cols-4 gap-20 xl:gap-32 mx-auto rounded-xl text-xl text-white">
        <div class="h-52 w-80 bg-red-500 rounded-xl Card relative justify-center items-center grid grid-cols-1">
